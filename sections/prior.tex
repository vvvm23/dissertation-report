...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \textbf{Model} & \textbf{Maximum Tested Input} & \textbf{Latent Shape} & \textbf{Codebook Size} & \textbf{FID/val} & \textbf{FID/train} \\
        \hline
        VQ-VAE & $128 \times 128$ & $32 \times 32 \times 1$ & $1024$ & $100.0$ & $100.0$ \\
        \hline
        VQ-VAE-2 & $128 \times 128$ & $32 \times 32 \times 1$ & $1024$ & $100.0$ & $100.0$ \\
        \hline
        DALLE & $128 \times 128$ & $32 \times 32 \times 1$ & $1024$ & $100.0$ & $100.0$ \\
        \hline
        VQ-GAN & $128 \times 128$ & $32 \times 32 \times 1$ & $1024$ & $100.0$ & $100.0$ \\
        \hline
        RVQ-VAE & $128 \times 128$ & $32 \times 32 \times 1$ & $1024$ & $100.0$ & $100.0$ \\
        \hline
    \end{tabular}
    \caption[Table]{Summary of various \acrfull{vq} methods. Latent shapes
    calculated from largest tested input.}
\end{table}

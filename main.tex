...
\begin{figure}[ht]
    ...
    \caption{
        ...
        VQ-GAN decoding. At this resolution, autoregressive and (non-adversarial)
        non-autoregressive models take minutes to sample, or simply do not
        scale to this resolution. Training is similarly fast, with the FFHQ1024
        model taking 4 days to train on a single Nvidia V100 32GiB.
    }
    \label{fig:main}
\end{figure}
